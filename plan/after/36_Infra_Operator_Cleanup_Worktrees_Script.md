...
- [x] Create .claude/scripts/cleanup-worktrees.sh with --dry-run default, --execute, --help
- [x] Test: dry-run verified (no removal on non-merged branches)
- [x] Test: main worktree skip verified
- [x] Report written to reports/36_Infra_Operator_cleanup-worktrees_2026-05-16.md
- [x] Commit with footer Refs: plan/before/36_Infra_Operator_Cleanup_Worktrees_Script.md
