...
public class RedisConfig {
    ...
    // Method name + @Primary to avoid BeanDefinitionOverrideException with
    // Spring Boot's auto-configured `cacheManager` bean (CacheAutoConfiguration).
    // @Cacheable resolves to this bean via @Primary.
    @Bean
    @Primary
    public RedisCacheManager liveClassCacheManager(RedisConnectionFactory cf) {
